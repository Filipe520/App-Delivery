...
import { FoodProps } from "../trending/food";
...
export default function CardHorizontalFood({ food }: { food: FoodProps }) {
  return (
    <Pressable className="flex flex-col rounded-xl relative">
      ...
      <View className="flex flex-row bg-neutral-900/90 w-fit gap-1 rounded-full absolute right-2 top-2 px-2 py-1 items-center justify-center">
